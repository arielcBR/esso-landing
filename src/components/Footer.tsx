    ...
    <footer className="container">
      <div className="grid grid-cols-1 gap-12 py-6 md:grid-cols-[50%_50%] md:gap-x-8 md:pt-12 lg:grid-cols-[60%_40%] xl:grid-cols-[auto_auto_auto] xl:py-16">
        <div className="flex flex-col items-center gap-4 w-full lg:items-start">
          ...
          <p className="text-center text-white text-sm lg:text-justify">
            Somos uma consultoria em engenharia, especializada em oferecer
            soluções seguras e eficientes para a indústria. Descubra como
        ...
        <div
          id="contato"
          className="flex flex-col items-center gap-4 w-full lg:items-start"
        >
        ...
        <div className="flex flex-col items-center gap-4 w-full lg:items-start xl:hidden">
          <h5 className="text-xl font-bold text-center text-white">
            Acesso Rápido
          </h5>
